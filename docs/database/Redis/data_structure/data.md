...
原文链接 [Redis 数据结构 | 小林coding (xiaolincoding.com)](https://xiaolincoding.com/redis/data_struct/data_struct.html#listpack-结构设计)
...
![img](./pics/data/9fa26a74965efbf0f56b707a03bb9b7f.png)
...
![img](./pics/data/a9c3e7dc4ac79363d8eb8eb2290a58e6.png)
...
![img](./pics/data/f302fce6c92c0682024f47bf7579b44c.png)

这些数据结构的内部细节，我先不展开讲，后面在讲哈希表数据结构的时候，再详细地说说，因为用到的数据结构是一样的。这里先大概说下图中涉及到的数据结构的名字和用途：
...
![img](./pics/data/58d3987af2af868dca965193fb27c464.png)
...
![img](./pics/data/3c386666e4e7638a07b230ba14b400fe.png)
...
:::details C语言入门计算机的可以跳了

C 语言的字符串其实就是一个字符数组，即数组中每个元素是字符串中的一个字符。

比如，下图就是字符串“xiaolin”的 char* 字符数组的结构：

![img](./pics/data/376128646c75a893ad47914858fa2131.png)
...
![img](./pics/data/bcf6bde3b647bdc343efcbc1a8f10579.png)
...
![img](./pics/data/6286480eb1840a8930e18fd215d82565.png)
...
![img](./pics/data/516738c4058cdf9109e40a7812ef4239.png)
...
简而言之，二进制安全就是可以使用任意字符进行数据传输，而不限于ASCII等。
```
...
![img](./pics/data/35820959e8cf4376391c427ed7f81495.png)
...
![img](./pics/data/47e6c8fbc17fd6c89bdfcb5eedaaacff.png)
...
![img](./pics/data/4fecbf7f63c73ec284a4821e0bfe2843.png)
...
![img](./pics/data/cadf797496816eb343a19c2451437f1e.png)
...
![img](./pics/data/ab0b44f557f8b5bc7acb3a53d43ebfcb.png)
...
![img](./pics/data/a3b1f6235cf0587115b21312fe60289c.png)
...
![img](./pics/data/462c6a65531667f2bcf420953b0aded9.png)

因为这些节点长度值小于 254 字节，所以 prevlen 属性需要用 1 字节的空间来保存这个长度值。

这时，如果将一个长度大于等于 254 字节的新节点加入到压缩列表的表头节点，即新节点将成为 e1 的前置节点，如下图：

![img](./pics/data/d1a6deff4672580609c99a5b06bf3429.png)

因为 e1 节点的 prevlen 属性只有 1 个字节大小，无法保存新节点的长度，此时就需要对压缩列表的空间重分配操作，并将 e1 节点的 prevlen 属性从原来的 1 字节大小扩展为 5 字节大小。

多米诺牌的效应就此开始。

![img](./pics/data/1f0e5ae7ab749078cadda5ba0ed98eac.png)
...
![img](./pics/data/dc495ffeaa3c3d8cb2e12129b3423118.png)
...
![img](./pics/data/753724a072e77d139c926ecf1f049b29.png)
...
![img](./pics/data/675c23857a36b2dab26ed2e6a7b94b5d.png)
...
![img](./pics/data/2fedbc9cd4cb7236c302d695686dd478.png)
...
![img](./pics/data/cabce0ce7e320bc9d9b5bde947b6811b.png)
...
![img](./pics/data/85f597f7851b90d6c78bb0d8e39690fc.png)
...
![img](./pics/data/5dbdfa7cfbdd1d12a4d9458c6c90d472.png)

现在，往这个整数集合中加入一个新元素 65535，这个新元素需要用 int32_t 类型来保存，所以整数集合要进行升级操作，首先需要为 contents 数组扩容，**在原本空间的大小之上再扩容多 80 位（4x32-3x16=80），这样就能保存下 4 个类型为 int32_t 的元素**。

![img](./pics/data/e2e3e19fc934e70563fbdfde2af39a2b.png)

扩容完 contents 数组空间大小后，需要将之前的三个元素转换为 int32_t 类型，并将转换后的元素放置到正确的位上面，并且需要维持底层数组的有序性不变，整个转换过程如下：

![img](./pics/data/e84b052381e240eeb8cc97d6b729968b.png)
...
![img](./pics/data/2ae0ed790c7e7403f215acb2bd82e884.png)
...
![img](./pics/data/a5b6512be0da36f87c5d906cc278526c.png)
...
![img](./pics/data/47275977397a5ab24dc64000c04e9427.png)
...
![img](./pics/data/2802786ab4f52c1e248904e5cef33a74.png)
...
![img](./pics/data/cdc14698f629c74bf5a239cc8a611aeb.png)
...
![img](./pics/data/f46cbe347f65ded522f1cc3fd8dba549.png)
...
![img](./pics/data/4d2dc376b5fd68dae70d9284ae82b73a.png)

listpack 头包含两个属性，分别记录了 listpack 总字节数和元素数量，然后 listpack 末尾也有个结尾标识。图中的 listpack entry 就是 listpack 的节点了。

每个 listpack 节点结构如下：

![img](./pics/data/c5fb0a602d4caaca37ff0357f05b0abf.png)
