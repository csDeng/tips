...
![图片](./pics/index_no_work/a9e6a9708a6dbbcc65906d1338d2ae70.png)
...
:::details 接下来，我举个例子，给大家展示下这两种存储引擎的索引存储结构的区别。

这里有一张 t_user 表，其中 id 字段为主键索引，其他都是普通字段。

![图片](./pics/index_no_work/00730eac527c21a4034f0f9ba0218aba.png)

如果使用的是 MyISAM 存储引擎，B+ 树索引的叶子节点保存数据的物理地址，即用户数据的指针，如下图：

![图片](./pics/index_no_work/f287701eba9bf6f32a2d09b013bb451b.png)

如果使用的是 InnoDB 存储引擎， B+ 树索引的叶子节点保存数据本身，如下图所示：

![图片](./pics/index_no_work/ef726d7287b854ea4862f7442d8012ec.png)
...
![图片](./pics/index_no_work/7dd91be9fe584d94a4d71572ae7214d0.png)
...
![图片](./pics/index_no_work/3175fdd8a7d00aa7edeb18bc90e63333.png)
...
![图片](./pics/index_no_work/c5c1506ac9fe3fdb98085e7e09c48394.png)
...
![图片](./pics/index_no_work/b161c1d88f978e42077f8c14e10972a7.png)
...
### ![图片](./pics/index_no_work/2525f7b7190eeb70323579e8d665eb94.png)为什么对索引使用函数，就无法走索引了呢？
...
![图片](./pics/index_no_work/56fc9a5a9b35d933f810e5213b3c8acb.png)
...
![图片](./pics/index_no_work/798ab1331d1d6dff026e262e788f1a28.png)

但是，如果把查询语句的条件改成 where id = 10 - 1，这样就不是在索引字段进行表达式计算了，于是就可以走索引查询了。

![图片](./pics/index_no_work/96c3132ade7b161a5c2a3c051b337402.png)
...
![图片](./pics/index_no_work/e7aa91ce5e699ff0c6c357f6b1e70597.png)
...
![图片](./pics/index_no_work/7be4dcbe00f15c8c583f20ffd67b772a.png)
...
![图片](./pics/index_no_work/028df5ce4a42a6cf33524b2e1102c15d.png)
...
![图片](./pics/index_no_work/25316fd06cadff4434f02391ef0b5c55.png)
...
### ![图片](./pics/index_no_work/28f252422b6c5e49cc81c448d08547dc.png)为什么联合索引不遵循最左匹配原则就会失效？
...
![图片](./pics/index_no_work/550dc58c222cc8d2740985e8d6497821.png)

这是因为 OR 的含义就是两个只要满足一个即可，因此只有一个条件列是索引列是没有意义的，只要有条件列不是索引列，就会进行全表扫描。

要解决办法很简单，将 age 字段设置为索引即可。

![图片](./pics/index_no_work/7f72c4ef72b7b979c844798d7be06916.png)
