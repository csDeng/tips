...
本文源于：https://mp.weixin.qq.com/s/hVsH_dBfd2ZWPaivBbgyrg
...
![图片](./pics/division/640.png)

**分表**：就是一个数据库表分成多个表。

![图片](./pics/division/640-16521697098591.png)
...
![图片](./pics/division/640-16521697098602.png)

假设B+树的高度为2的话，即有一个根结点和若干个叶子结点。这棵B+树的存放总记录数为=根结点指针数*单个叶子节点记录行数。

- 如果一行记录的数据大小为1k，那么单个叶子节点可以存记录数  `=16k/1k =16`.
...
![图片](./pics/division/640-16521697098603.png)

#### 3.1.1 垂直分库

在业务发展初期，业务功能模块比较少，为了快速上线和迭代，往往采用单个数据库来保存数据。数据库架构如下：

![图片](./pics/division/640-16521697098604.png)
...
![图片](./pics/division/640-16521697098605.png)
...
![图片](./pics/division/640-16521697098606.png)
...
![图片](./pics/division/640-16521697098607.png)
...
![图片](./pics/division/640-16521697098608.png)
...
![图片](./pics/division/640-16521697098619.png)
...
![图片](./pics/division/640-165216970986110.png)
...
既然range存在热点数据问题，hash取模扩容迁移数据比较困难，我们可以综合两种方案一起嘛，取其长，弃其短。
...
![图片](./pics/division/640-165216970986111.png)
...
:::details 为什么是500w的参考链接

[MySQL单表数据不要超过500万行：是经验数值，还是黄金铁律？ - 掘金 (juejin.cn)](https://juejin.cn/post/6844903872134135816)

[为什么说MySQL单表数据不要超过500万行（转） - 系统攻城狮 - 博客园 (cnblogs.com)](https://www.cnblogs.com/xujanus/p/12755996.html)
...
![图片](./pics/division/640-165216970986112.png)